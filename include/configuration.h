...
#define MOTOR_LEFT_A_PIN 3 // Left motor direction A (PWM supported)
#define MOTOR_LEFT_D_PIN 5 // Left motor direction D (PWM supported)

// MOTOR_PIN_RIGHT - Right Motor Control Pins
#define MOTOR_RIGHT_EN 4    // Right motor enable pin
#define MOTOR_RIGHT_D_PIN 6 // Right motor direction D (PWM supported)
#define MOTOR_RIGHT_A_PIN 9 // Right motor direction A (PWM supported)
...
#define PS2_SEL 10 // Select pin of the PS2 controller
